...
# --- Find Abstract_ID values that appear in both df and df.gpt ---
common_ids <- intersect(df$Abstract_ID, df.gpt$Abstract_ID)

# --- Mark rows in df as "yes" if Abstract_ID exists in df.gpt ---
df$llm.gpt5.2[df$Abstract_ID %in% common_ids] <- "yes"
